...
router.put("/confirmation", BookingConfirmationValidator,  bookingController.ConfirmBooking )
...
router.get("/getOne/:id",  mustBeSuperAdminOrAdmin, bookingController.getOneBooking  )
